...
# BASED ON d:\repos\stm32\projects\can-bridge_v0.4-f412
...
target_link_options(
    ...
    "$<$<NOT:$<CONFIG:Debug>>:-mfloat-abi=hard>"
    -T
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/STM32F412RETX_FLASH.ld>"
    "$<$<NOT:$<CONFIG:Debug>>:${PROJECT_SOURCE_DIR}/STM32F412RETX_FLASH.ld>"
)

target_sources(
    ${TARGET_NAME} PRIVATE
    "Core\\Src\\CAN\\CAN_utils.c"
    "Core\\Src\\freertos.c"
    "Core\\Src\\main.c"
    "Core\\Src\\RTC\\RTC_utils.c"
